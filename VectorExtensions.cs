...
namespace GrandPrixApp
{
	public static class VectorExtensions
	{
		...
		{
			return list.OrderBy(a => Guid.NewGuid()).FirstOrDefault();
		}

		public static IEnumerable<TSource> Random<TSource>(this IEnumerable<TSource> list, int count)
		{
			return list.OrderBy(a => Guid.NewGuid()).Take(count);
		}
	}
